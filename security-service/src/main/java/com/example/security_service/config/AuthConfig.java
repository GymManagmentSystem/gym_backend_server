    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("api/v1/auth/token", "api/v1/auth/validate","api/v1/auth/register","/api/v1/auth/member/password/new","/api/v1/auth/member/password/reset").permitAll() // Permit specific endpoints
